...
gulp.task('nunjucks', function() {
  ...
  .pipe(nunjucksRender({
    path: ['./templates/layouts/', './templates/partials/', './templates/pages/']
    }))
...
gulp.task('watch', function (done) {
  ...
  // PAGES
  // Watch .html pages as they can be recompiled individually
  gulp.watch(['templates/layouts/**/*', 'templates/partials/**/*', 'templates/pages/**/*'], {
    cwd: './'
  }, gulp.series('nunjucks', 'html', function reloadPage(done) {
    reload();
    done();
  }));
...
gulp.task('default', gulp.series('clean:dist', 'copy-assets', gulp.series('nunjucks', 'html', 'sass', 'sass-min', 'bootstrapjs', 'mrarejs'), gulp.series('serve', 'watch')));

gulp.task('build', gulp.series('clean:dist', 'copy-assets', gulp.series('nunjucks','html', 'sass', 'sass-min', 'bootstrapjs', 'mrarejs')));
